...
// 模型配置参数 - 参考person_detection
#define TENSOR_ARENA_SIZE (136 * 1024)  // 与person_detection保持一致

// 函数声明
namespace my_model {

/**
 * @brief 初始化模型 - 对应person_detection的setup()函数
 ...
 * @param image_data 输入图像数据指针 (96x96x1, int8格式)
