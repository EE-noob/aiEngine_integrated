`ifndef AI_NICE_REG_MODEL_SV
`define AI_NICE_REG_MODEL_SV

`include "ai_csr_defines.svh"

class ai_nice_csr_reg extends uvm_reg;
    `uvm_object_utils(ai_nice_csr_reg)

    rand uvm_reg_field data;

    function new(string name = "ai_nice_csr_reg");
...
class ai_nice_reg_block extends uvm_reg_block;
    `uvm_object_utils(ai_nice_reg_block)

    rand ai_nice_csr_reg mult_lhs_ptr;
    rand ai_nice_csr_reg mult_rhs_ptr;
    rand ai_nice_csr_reg mult_dst_ptr;
    rand ai_nice_csr_reg mult_bias_ptr;
    rand ai_nice_csr_reg mult_lhs_rows;
    rand ai_nice_csr_reg mult_rhs_cols;
    rand ai_nice_csr_reg mult_rhs_rows;
    rand ai_nice_csr_reg mult_dst_stride;
    rand ai_nice_csr_reg mult_lhs_stride;
    rand ai_nice_csr_reg mult_rhs_stride;
    rand ai_nice_csr_reg mult_lhs_offset;
    rand ai_nice_csr_reg mult_rhs_offset;
    rand ai_nice_csr_reg mult_dst_offset;
    rand ai_nice_csr_reg mult_dst_mult;
...
`endif
        ...
        mult_rhs_ptr = ai_nice_csr_reg::type_id::create("mult_rhs_ptr",,get_full_name());
        mult_rhs_ptr.build();
        ...
        mult_dst_ptr = ai_nice_csr_reg::type_id::create("mult_dst_ptr",,get_full_name());
        mult_dst_ptr.build();
        ...
        mult_bias_ptr = ai_nice_csr_reg::type_id::create("mult_bias_ptr",,get_full_name());
        mult_bias_ptr.build();
        ...
        mult_lhs_rows = ai_nice_csr_reg::type_id::create("mult_lhs_rows",,get_full_name());
        mult_lhs_rows.build();
        ...
        mult_rhs_cols = ai_nice_csr_reg::type_id::create("mult_rhs_cols",,get_full_name());
        mult_rhs_cols.build();
        ...
        mult_rhs_rows = ai_nice_csr_reg::type_id::create("mult_rhs_rows",,get_full_name());
        mult_rhs_rows.build();
        ...
        mult_dst_stride = ai_nice_csr_reg::type_id::create("mult_dst_stride",,get_full_name());
        ...
        mult_lhs_stride = ai_nice_csr_reg::type_id::create("mult_lhs_stride",,get_full_name());
        ...
        mult_rhs_stride = ai_nice_csr_reg::type_id::create("mult_rhs_stride",,get_full_name());
        ...
        mult_lhs_offset = ai_nice_csr_reg::type_id::create("mult_lhs_offset",,get_full_name());
        ...
        mult_rhs_offset = ai_nice_csr_reg::type_id::create("mult_rhs_offset",,get_full_name());
        ...
        mult_dst_offset = ai_nice_csr_reg::type_id::create("mult_dst_offset",,get_full_name());
        ...
        mult_dst_mult = ai_nice_csr_reg::type_id::create("mult_dst_mult",,get_full_name());
        mult_dst_mult.build();
        ...
        mult_dst_shift = ai_nice_csr_reg::type_id::create("mult_dst_shift",,get_full_name());
        ...
        mult_act_min = ai_nice_csr_reg::type_id::create("mult_act_min",,get_full_name());
        mult_act_min.build();
        ...
        mult_act_max = ai_nice_csr_reg::type_id::create("mult_act_max",,get_full_name());
        mult_act_max.build();
