...
| soc_top                       |
|                               |
| 0x0000_0000 CPU RAM           |  <- cpu.mem, C 程序和栈
| 0x1000_0000 MMA AXI-Lite      |  -> axil_top_with_ram
| 0x2000_0000 SoC ctrl/status   |  <- finish/status/trap
+-------------------------------+
        |
        v
axil_top_with_ram
        |
        +-- mma_axil_top: AXI-Lite CSR + MMA core
        |
