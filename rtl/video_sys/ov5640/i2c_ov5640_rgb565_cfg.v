...
localparam  [12:0]  cmos_h_pixel = 13'd1280 ;//ͼ�񳤶�
localparam  [12:0]  cmos_v_pixel = 13'd960 ;//ͼ�����
//reg define
...
always @(posedge clk or negedge rst_n) begin
    if(!rst_n)
        ...
        case(init_reg_cnt)
            ...
            8'd54 : i2c_data <= {16'h4300,8'h10}; //��ʽ���� Y8
            ...
            //ˮƽ�����ش�С��8λ 
            8'd225: i2c_data <= {16'h380d,8'h68};
            //��ֱ�����ش�С��5λ 
            8'd226: i2c_data <= {16'h380e,8'h03};
            //��ֱ�����ش�С��8λ     
            8'd227: i2c_data <= {16'h380f,8'hd8};
